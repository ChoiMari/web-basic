...
<body>
	...
	<div id="pageContainer">
		<div style="padding-top: 25px; text-align: center">
			<form name="bbs" action="board_rewriteok.do?idx=${requestScope.idx}" method="POST">
				...
				<table width="95%" border="2" align="center">
					<tr>
						...
						<td width="80%" align="left">
							<input type="text" name="subject" size="40" value="[RE]${requestScope.subject}">
						</td>
