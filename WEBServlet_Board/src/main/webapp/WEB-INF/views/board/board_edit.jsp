...
<c:choose>
    ...
    데이터 오류
    <hr><a href='board_list.do'>목록가기</a>
    </c:when>
    <c:otherwise>
                    ...
                    <center>
                        <table width="90%" border="1">
                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    <input type="text" name="writer" value="${requestScope.board.writer}">
                                </td>
                                <td width="20%" align="center"><b>홈페이지</b></td>
                                <td>
                                    <input type="text" name="homepage" value="${requestScope.board.homepage}">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="email" value="${requestScope.board.email}">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <input type="text" name="subject" value="${requestScope.board.subject}" size="40">
                                </td>
                            </tr>
                            <tr height="100">
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <c:if test="${requestScope.board.filename != null}">
                                        ${requestScope.board.filename} (${requestScope.board.filename} bytes)<br /> 
                                    </c:if>
